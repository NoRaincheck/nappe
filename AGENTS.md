...
- **parser** — tree-sitter parsing, concrete syntax tree construction
- **transforms** — Delete, Unwrap, Unify identifiers, Dead definition removal
- **reducer** — Perses-style priority queue with caching and parallel testing
- **cli** — command-line interface (argparse or click)
- **grammar** — tree-sitter grammar management and node type compatibility
