# Program Reduction: A Survey and Assessment of nappe
...
program reduction tools and techniques, situates **nappe** (a pure Python
...
**nappe** is a pure Python implementation of the Perses algorithm, based
...
### 3.1 What is novel about nappe?

**Short answer: the algorithm is not novel.** nappe is a faithful
...
**Consequence:** nappe will be significantly slower and produce larger
...
| Feature                                                                      | Present in                                                                    | Missing from nappe |
| ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------- |
...
11. **Implement PNF normalization.** This is the core of Perses's theoretical
    ...
    bring nappe to full Perses parity.
...
14. **Add a Shrinkray backend mode.** Instead of the current `shrink` subcommand
    that reimplements the reducer, implement nappe as a Shrinkray
...
| **nappe** | Python                 | Simplified Perses           | Yes (every step) | No            | 1-tree-minimal (simplified) | tree-sitter       |
...
**nappe occupies a specific niche:** it is the most accessible Python
...
With these changes, nappe could become the go-to Python-native program
